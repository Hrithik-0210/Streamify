...
const SearchVideoCard = ({ item }) => {
  ...
  return (
    <div className="video-card-container  transition ease-linear delay-150  duration-200 w-[65svw] h-fit   rounded-2xl    grid grid-flow-col grid-cols-12 gap-2  ">
      <div className="thumbnail-container rounded-xl  w-full h-52 items-center  m-2 col-span-5 overflow-hidden hover:rounded-sm transition-all ease-linear delay-100 duration-150">
        <img
